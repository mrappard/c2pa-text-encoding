...
* Svensson, P. (2023). *Micro-scale interactions in marine systems.* Marine Ecology Progress Series.

---

### **Appendix A: Photosynthetic Efficiency Ratio**
...
* ( F_m ) = maximum fluorescence
* ( F_0 ) = minimum fluorescence
