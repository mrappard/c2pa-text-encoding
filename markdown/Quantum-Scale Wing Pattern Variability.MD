...
1. Do micro-irregularities in scale placement affect thermodynamic performance?
2. Can these irregularities influence predator perception in natural environments?
...
### **Appendix A: Pattern Entropy Formula**

[
H = -\sum_{i=1}^{n} p_i \log_2 p_i
]

Where ( p_i ) represents the probability distribution of scale orientations within a defined wing region.
